...
- 非数学西文字母统一为 Pagella 正体，保留粗细区别；定理正文、证明标题、术语原文及所有列表序号同样正体。术语原文仍用半角括号；行内、行间数学保留 Latin Modern Math，黑板粗体保留 AMS。
...
- 现行版本：格式规范 1.10、写作规范 1.6、术语规范 1.19、工作流程说明 2.6、书目维护注意事项 0.3。旧试排和历史审核记录不覆盖现行条款。
