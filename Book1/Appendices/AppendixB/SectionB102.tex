...
这里的外积与第\ref{b1:subsec:170104}小节的外积是同一个构造；下面的基定理会说明它们的对应关系，故不重复登记“外积”的主索引。由商关系有 \(v\wedge v=0\)，再将 \(v+w\) 代入便得
\[
 v\wedge w=-w\wedge v.
\]
...
\]
这正是第十七章的子式构造。外代数的取商定义说明该公式为何能在任意基下成立；子式公式则提供实际计算的方法。两种表述各自解决一个问题，不需要在“抽象”与“计算”之间二选一。
