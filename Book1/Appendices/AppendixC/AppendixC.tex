...
读者应熟悉第八章的 Hahn--Banach 定理、开映射定理、Hilbert 投影和紧算子，
以及第九章的弱拓扑与自然嵌入。商空间完备性及其对偶已经在%
...
Hunter 与 Nachtergaele 的《Applied Analysis》\cite{Hunter2001Applied}第 8.3 节
...
% 八题均为自拟；逐题注释列出训练增量。
% 不复述第八章商空间、c0对偶及第九章双零化子、范数不取得的既有习题。
...
\end{enumerate}
\end{exercise}
% 来源：自拟；调用第九章已有范数不取得反例，新增最近点失败与对偶取得性并存的对比。
\begin{solution}
第一部分中，
\[
