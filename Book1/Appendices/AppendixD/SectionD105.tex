...
\cite{Simon1983Lectures}第31节在整数重数流之间采用要求分解项也为整数重数的局部距离。
...
与第\ref{b1:ch:25}章的平移紧性准则相似，证明先把对象统一磨光，
再把小尺度误差与固定尺度下的紧性分开。
...
\cite{Simon1983Lectures}第29.1条及其缩放版本29.3；该版本对 \(\mathbf M(P)\)
...
\cite{Simon1983Lectures}第32.1--32.3条给出完整证明，
