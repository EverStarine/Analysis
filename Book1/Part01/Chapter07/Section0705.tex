...
\[
\Phi(y)-\Phi(x)=\int_0^1D\Phi\bigl(x+t(y-x)\bigr)(y-x)\,dt,
\]
...
\(\nu(E)=\int_Eh\,\mathrm d(m_d)_U=\int_Eh\,dx\)。
...
\[
\int_{\Phi(E)}g(y)\,dy
=\int_E g\bigl(\Phi(x)\bigr)J_\Phi(x)\,dx.
\]
...
=\int_E\mathbf1_B\bigl(\Phi(x)\bigr)\cdot J_\Phi(x)\,dx.
\]
...
g(r\cdot \cos\theta,r\cdot \sin\theta)\,r\,dr\,d\theta.
\]
