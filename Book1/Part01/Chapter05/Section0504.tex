...
\]
逐点检查 \(f\) 对参数的变化以后，还要找到对附近参数同时有效的可积控制。控制函数在这里的作用，可对照 Sheldon Axler 的《Measure, Integration \& Real Analysis》\cite[Section 3B]{Axler2020Measure}关于控制收敛的论证。以下允许被积函数取实值或复值；记号 \(dx\) 表示对一维 Lebesgue 测度积分。
...
\[
\dfrac{d^j}{dt^j}\int_{\mathbb R}e^{itx}\cdot h(x)\,\mathrm dx
