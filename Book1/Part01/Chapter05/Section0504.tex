...
相应的\term[hancan-bianliang-jifen]{含参变量积分}[parameter integral]是参数 \(t\) 的函数，记为%
\footnote{V.~A. Zorich《数学分析》第二卷第四版中译本\cite{Zorich2007AnalysisIIChinese}第 17 章使用这一名称；华东师范大学数学系《数学分析》下册第四版\cite{ECNU2012AnalysisII}第 19 章称为含参量积分\termidx[hancanliang-jifen]{含参量积分}。两种译名均指把积分看作参数的函数；本书后文统一使用“含参变量积分”。}%
\[
