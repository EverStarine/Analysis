...
这些都是逐点计算，尚未限制异常点集的大小。\cref{b1:thm:lebesgue-density}将证明：对任意 Lebesgue 可测集 \(E\)，几乎每个属于 \(E\) 的点都是密度点，而在补集内密度几乎处处为零。该结论将在下一节从积分的微分定理推出，这里不把它作为已知性质使用。中文伴读可参看那汤松的《实变函数论》第5版中译本\cite[\chapref{b1:ch:09}第6节]{Natanson2010RealChinese}，该书以“稠密点、近似连续”为这一话题的节名；本书使用“密度点”，将它与拓扑意义下的稠密性分开。
