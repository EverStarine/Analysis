...
\[
 ...
 \quad (a,b)\in D_t,
\]
其中 \(D_t=\{\,(a,b)\in[0,1]^2\mid t-1\le a+b\le t\,\}\)。该参数映射的 Jacobi 因子为 \(\sqrt3\)，故截面积等于 \(\sqrt3m_2(D_t)\)。若 \(t_n\to t\)，则除 \(a+b=t-1\) 和 \(a+b=t\) 两条零测直线外，\(\mathbf1_{D_{t_n}}\to\mathbf1_{D_t}\)。控制收敛定理给出 \(m_2(D_{t_n})\to m_2(D_t)\)。截面积与上面的 \(\sqrt3V'\) 都连续，而它们几乎处处相等，因而处处相等。
