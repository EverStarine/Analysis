...
上一章还给出了一个非光滑来源。若 \(f:\mathbb R^m\to\mathbb R^n\) 是 Lipschitz 的且 \(m>n\)，则其几乎每个水平集都可数 \((m-n)\) 维可整流。事实上，余面积证明中的满秩坐标片在固定目标值后由 \(\mathbb R^{m-n}\) 的子集作 Lipschitz 参数化，临界与不可微部分则在几乎每层上为零测。把各子集上的参数映射延到全空间，正好满足本定义。\(m=n\) 时，相应结论是几乎每个纤维至多可数，可按零维约定理解。
