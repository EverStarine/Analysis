...
\]
称 \(\mathcal H^s\) 为 \(s\) 维\term[hausdorff-ce-du]{Hausdorff 外测度}[Hausdorff outer measure]；\linebreak[1]把它限制到 Carathéodory 可测集上得到的测度，称为 \(s\) 维\term[hausdorff-cedu]{Hausdorff 测度}[Hausdorff measure]。下面将证明所有 Borel 集都在其可测域内。讨论 Borel 测度时，我们也把相应的限制记为 \(\mathcal H^s\)。
