...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:15-snowflake-metric}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:15-holder-graphs}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:15-zero-dimensional-compact}
令
\[
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:15-energy-choice}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:15-separated-similarities}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:15-cantor-product}
