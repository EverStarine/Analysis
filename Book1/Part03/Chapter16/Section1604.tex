...
对于实函数，上式的分割上确界就是其全变差。下一定理是后面度量速度证明的实值基础。Fremlin 的《Measure Theory》\cite[225B--E]{Fremlin2016Measure}系统讨论绝对连续函数及其积分表示；下面采用\chapref{b1:ch:06}的 Radon--Nikodym 定理来证明表示方向，使这里不依赖尚未建立的一般有界变差函数微分理论。
