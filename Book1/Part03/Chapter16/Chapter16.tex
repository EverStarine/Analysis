...
\[
 F_-(x)=\sup_{a\in A}\bigl(f(a)-L\cdot d(x,a)\bigr),
 \quad
 F_+(x)=\inf_{a\in A}\bigl(f(a)+L\cdot d(x,a)\bigr).
\]
\begin{enumerate}
...
\[
 f(a)-L\cdot d(x,a)\le F(x)\le f(a)+L\cdot d(x,a),
\]
...
由
\[
 \frac{f(h)-f(0)}h=1+2h\cdot \sin(1/h)\longrightarrow1
\]
可知 \(f'(0)=1\)。对 \(x\ne0\)，
\[
 f'(x)=1+4x\cdot \sin(1/x)-2\cdot \cos(1/x),
\]
