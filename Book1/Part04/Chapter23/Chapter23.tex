...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:23-smooth-integer-limit}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:23-circle-energy}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:23-higher-zero-endpoints}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:23-smooth-normal-data}
