...
有限图表、反射和单位分解的几何组织，可对照 Di Nezza、Palatucci 与 Valdinoci 的《Hitchhiker's guide to the fractional Sobolev spaces》\cite{DiNezza2012Hitchhikers}第5节。该文讨论分数阶空间；下面的一阶证明则使用前章的沿线绝对连续代表与双 Lipschitz 换元，不由分数阶结论直接推出。
