...
\[
 \{\,v\in W_0^{1,p}(D):v\ge1\text{ 几乎处处于 }\operatorname{int}K_m\,\}
\]
在 \(L^p(D)\) 中闭且凸，因而在 \(W_0^{1,p}(D)\) 中也是弱闭集。故 \(\varphi\ge1\) 几乎处处于每个 \(\operatorname{int}K_m\)，也就几乎处处于 \(G\)。梯度能量的弱下半连续性给出
\[
