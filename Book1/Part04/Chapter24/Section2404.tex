...
Hajłasz 的《Sobolev spaces on metric-measure spaces》\cite{Hajlasz2003SobolevMetric}第9.4定理提供了这种均值比较的系统组织。整数阶和分数阶条件如何产生平均振荡界，各有自己的证明；将这些条件放在同一尺度观点下理解，也有助于辨清\secref{b1:sec:2405}临界情形中哪些步骤不再成立。
