...
\[
 ...
 =-\int_Qy\cdot \varphi(x,y)\,\mathrm dx\,\mathrm dy.
\]
...
在 \(I=(0,1)\) 上令
\[
 u_n(x)=x+n^{-2}\cdot \sin(nx),\qquad u(x)=x.
\]
...
两函数光滑，且
\[
 u_n-u=n^{-2}\cdot \sin(nx),\qquad
 u_n'-u'=n^{-1}\cdot \cos(nx).
\]
...
\[
 u_r(x)=r^{1-d/p}\cdot \psi(x/r),\quad 0<r<1.
\]
...
\[
 v_n'=n\cdot\mathbf1_{(0,1/n)},\quad
...
\[
 \int_Ig|u_n'|^2
 =\frac12\int_Ig+\frac12\int_Ig\cdot \cos(2nx)
...
\[
 \Psi'=\frac12\cdot\mathbf1_{(-1,0)}+\frac32\cdot\mathbf1_{(0,1)}.
\]
