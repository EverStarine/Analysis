...
只知道 \(u,v\in W^{1,p}\) 时，不能无条件断言乘积仍属于 \(W^{1,p}\)。弱导数公式并不自动提高 \(u\partial_i v\) 的可积性；\chapref{b1:ch:24}的嵌入定理以后会提供另外一些充分条件。习题\ref{b1:ex:21-product-integrability-loss}则直接构造乘积失去原有可积性的例子。
