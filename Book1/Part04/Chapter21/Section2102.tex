...
Hunter 与 Nachtergaele 的《Applied Analysis》\cite[第12.9节，第363页]{Hunter2001Applied}在 Sobolev 空间定义之后列出 Banach 与 Hilbert 结构。本节从\chapref{b1:ch:10}的 \(L^p\) 理论出发证明这些结论，并展开连续泛函如何由导数分量表示。以下固定非空开集 \(\Omega\subseteq\mathbb R^d\)、\(k\in\mathbb N_0\) 及标量域 \(\mathbb K=\mathbb R\) 或 \(\mathbb C\)，不要求 \(\Omega\) 有界或具有规则边界。
