...
Hunter 与 Nachtergaele 的《Applied Analysis》\cite[\S12.9，定义12.66及其后讨论]{Hunter2001Applied}把这些空间放在弱导数之后引入。接下来我们将把导数作为 \(L^p\) 中的有限组分量，直接从\chapref{b1:ch:10}的完备性推导其基本结构。
