...
\[
 ...
 =\bigl\{u=(u^1,\ldots,u^m):u^a\in W^{k,p}(\Omega),\ 1\leq a\leq m\bigr\}.
\]
这里
\[
 \partial^\alpha u
 =\bigl(\partial^\alpha u^1,\ldots,\partial^\alpha u^m\bigr),
\]
...
\[
 ...
 =\bigl\{u=(u^1,\ldots,u^m):u^a\in W^{k,p}_{\mathrm{loc}}(\Omega),\ 1\leq a\leq m\bigr\}.
\]
