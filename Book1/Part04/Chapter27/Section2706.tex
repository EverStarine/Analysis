...
\begin{proof}
先把严格逼近改成全空间紧支集逼近。由%
\cref{b1:thm:bv-strict-approximation}，可取
...
由\hyperref[b1:prop:smooth-domain-perimeter]{光滑域周长公式\ref*{b1:prop:smooth-domain-perimeter}\CJKecglue}及球面积计算，
\[
...
\[
 \begin{aligned}
 \|\mathbf1_{B(0,R)}\cdot\min\{w,N\}\|_q
