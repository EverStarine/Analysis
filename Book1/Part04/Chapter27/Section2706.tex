...
Simon 的《Lectures on Geometric Measure Theory》\cite[第6节，第34--40页]{Simon1983Lectures}
把局部变差、磨光与 Poincaré 型估计放在同一条线上。
这里将前节的严格逼近接到第\ref{b1:sec:2402}节已经证明的端点 Sobolev 不等式，
再用余面积公式说明其集合意义。
...
\begin{theorem}[BV 的 Sobolev 端点估计]\label{b1:thm:bv-sobolev-endpoint}
...
现在对 \(v_j\) 应用定理\ref{b1:thm:gns-endpoint}：
\[
