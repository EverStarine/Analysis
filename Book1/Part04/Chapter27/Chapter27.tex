...
\item 掌握严格光滑逼近中的单位分解误差，区分局部紧性、全域紧性、弱-*\WeakStarJoin{}收敛和范数收敛。
...
\[
 v_{h,\theta}
   =h\cdot\sum_{k=0}^\infty\mathbf1_{\{u>\theta+kh\}}.
\]
...
\[
 |Dv_{h,\theta}|(\Omega)
 \le S_h(\theta)=
        h\cdot\sum_{k=0}^\infty P(\{u>\theta+kh\},\Omega).
\]
由 Tonelli 定理及 \(u\ge0\)，
\[
...
有限体积保证
\[
 \|v_j-u\|_1\le h_j\cdot m_d(\Omega)\longrightarrow0,
 \quad
...
以及允许取值 \(+\infty\) 的泛函
\[
 J(u)=|Du|(\mathbb R^d)+\int_{\mathbb R^d}|x|\cdot u(x)\,\mathrm dx.
\]
