...
Hanche-Olsen 与 Holden 的《The Kolmogorov--Riesz compactness theorem》\cite[第3节，定理5]{HancheOlsenHolden2010Compactness}采用有限维投影处理这一问题，并讨论不同文献中的定理命名。本节固定 \(d\geq1\)、\(1\leq p<\infty\) 和 \(\mathbb K=\mathbb R\) 或 \(\mathbb C\)。所有紧性均指 \(L^p\) 范数拓扑下的紧性，不是弱紧性。
...
有限 \(p\) 的限制不能直接删去。第\ref{b1:sec:1304}节已经指出，
\(u=\mathbf1_{(0,1)}\) 满足
