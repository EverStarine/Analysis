...
这里无需假设 \(X\) 完备。真正起作用的是凸分离；Fremlin 在更一般的局部凸空间中也以分离定理说明这一点\cite[Volume 4, 4A4Eb and 4A4Ed]{Fremlin2016Measure}。由此还能把弱收敛转化为一种范数逼近，不过必须允许作凸组合。
...
\[
 J\bigl((1-t)x+ty\bigr)<(1-t)J(x)+tJ(y),
\]
则此极小点唯一。
\end{theorem}
