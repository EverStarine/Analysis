...
\]
以这些集合为邻域基的拓扑称为 \(X^*\) 上的\term[ruo-xing-tuopu]{弱*\WeakStarJoin{}拓扑}[weak-* topology]，也称弱星拓扑，记为 \(\sigma(X^*,X)\)。\footnote{许全华、马涛、尹智的《泛函分析讲义》\cite[第八章]{Xu2017Fanhan}采用“弱*\WeakStarJoin{}拓扑”的写法；“弱星拓扑”的文字写法亦见科学出版社公布的\href{https://www.ecsponline.com/goods.php?id=41308}{《最优控制理论与应用中的若干问题》第2.4.1节目录}。}
\termsee[ruoxing-tuopu]{弱星拓扑}{弱*\WeakStarJoin{}拓扑}
\end{definition}
...
设 \((f_n)\subset X^*\) 且 \(f\in X^*\)。若 \(f_n(x)\to f(x)\) 对每个 \(x\in X\) 都成立，则称它\term[ruo-xing-shoulian]{弱*\WeakStarJoin{}收敛}[weak-* convergence]于 \(f\)，也称弱星收敛，记为 \(f_n\overset{*}{\rightharpoonup}f\)。\footnote{“弱星收敛”的名称亦见香港中文大学（深圳）的\href{https://www.cuhk.edu.cn/zh-hans/course/8198}{泛函分析课程简介}。}
\termsee[ruoxing-shoulian]{弱星收敛}{弱*\WeakStarJoin{}收敛}
\end{definition}
