...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:08-strong-finite-rank}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:08-compact-closed-range}
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:08-volterra}
在 \(L^2(0,1)\) 上定义%
\((Vf)(x)=\int_0^x f(y)\,dy\)。
...
\begin{exercise}[\(\star\) 选读]\label{b1:ex:08-green-resonance}
