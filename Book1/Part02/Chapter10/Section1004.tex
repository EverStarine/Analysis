...
本章各项结构结论在端点处并不对称。\cref{b1:tab:lp-exponent-structure}集中列出后文最常调用的差别；对偶一栏按本章的 \(\sigma\)-有限框架理解，而“非自反”只表示一般情形，有限维退化情形除外。
\begin{table}[htbp]
  \centering
  ...
  \begin{tabularx}{\textwidth}{@{}p{2.3cm}p{3.6cm}p{4.3cm}X@{}}
    ...
    指数 & 可分性 & 对偶表示 & 自反性 \\
    \midrule
    \(p=1\) & 在本章假设下可分 & \((L^1)^*=L^\infty\) & 一般不自反 \\
    \(1<p<\infty\) & 可分 & \((L^p)^*=L^q\) & 自反 \\
