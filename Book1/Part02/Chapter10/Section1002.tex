...
在 \(L^\infty\) 中，幅值截断对给定本性有界函数最终等于该函数，因而没有困难；困难在于区域截断。即使 \(E_n\uparrow X\)，也未必有 \(\|f-f\mathbf1_{E_n}\|_\infty\to0\)。在 \(\mathbb R\) 上取 \(f=1\)、\(E_n=[-n,n]\)，误差范数始终为 \(1\)。集合尾部虽然在逐点意义下消失，其上保留的误差高度并没有降低。
