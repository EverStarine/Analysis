...
% 空集统一取正文字体 Pagella 的 Ø（U+00D8，正圆带一杠）。
% 数学字体的 \varnothing 是 U+2205，在本套字体里呈瘦高的“0 加陡斜线”，
% 编写者要求圆形字形；unicode-math 中 \emptyset 只是 \varnothing 的别名
% （\protected\def\emptyset{\varnothing}），改命令名无效，故在此改字形。
% 注意：本字形不随上下标缩放，数学脚本位置保持文字尺寸。
\AtBeginDocument{\renewcommand{\varnothing}{\mathord{\text{\O}}}}
